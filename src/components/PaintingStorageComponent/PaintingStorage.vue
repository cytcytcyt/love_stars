<template>
    <div class="EScontainer">
        ...
        <el-row>
            <el-col :span="12">
                <el-row v-for="(i,index) in paintingsList1.slice((curPage-1)*(pageSize/2),curPage*(pageSize/2))" :key="index">
...
<!--                            <span class="article-title">手绘</span><br>-->
            ...
            <el-col :span="12">
                <el-row  v-for="(i,index) in paintingsList2.slice((curPage-1)*(pageSize/2),curPage*(pageSize/2))" :key="index">
...
<script>
    ...
    export default {
        ...
        mounted(){
            axios.get('http://localhost:8088/api/selectPictures')
                .then(response => {
