<template>
    <div>
        <el-button-group>
            <el-button type="warning" plain @click="show=1"><i class="el-icon-tickets"></i>文字</el-button>
            <el-button type="warning" plain @click="show=2"><i class="el-icon-picture"></i>图片</el-button>
            <el-button type="warning" plain @click="show=1"><i class="el-icon-document">长文章</i></el-button>
        </el-button-group>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            publishShortArticle() {
                console.log('publish')
                axios.post('http://localhost:8088/api/publishShortArticle',{
                        nameId: 1,
