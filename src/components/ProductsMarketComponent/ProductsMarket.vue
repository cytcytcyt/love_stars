<template>
    ...
    <el-row class="top-bar">
        ...
        <el-col :span="3" class="search-button">
            <el-button icon="el-icon-search" type="warning" circle @click="select"><!--搜索按钮-->
            </el-button>
        </el-col>
        <el-col :span="7" class="my-pocket">
            <el-button type="warning" round @click="drawer=true">
                我的购物袋
            </el-button>
        </el-col>
    </el-row>
    <el-row class="market">
        <el-col :span="6" v-for="(item,index) in shopItems.slice((curPage-1)*pageSize,curPage*pageSize)" :key="index" style="margin:2% 4%">
    ...
    export default {
        ...
        data () {
            return {
                ...
                shopItems:[],
                shopItemList: [{
                    imgurl: 'http://p7.itc.cn/q_70/images03/20200625/7aa025d76a2b4f5eb56d052c5fcda94e.jpeg',
                    name: 'KFC日向夏海报',
                    price: 10,
                    type:1
                }, {
                    imgurl: 'http://wx4.sinaimg.cn/orj360/9a0a99eely1gg9hp41wdtj20u01hc4e6.jpg',
                    name: 'KFC中国风海报',
                    price: 15,
                    type:1
                }, {
                    imgurl: 'http://www.t-chs.com/tuhsJDEwLmFsaWNkbi5jb20vaTMvOTAzMDQ3OTcvVEIyWTRJNXdCeVdCdU5rU21GUFhYWGd1VlhhXyEhOTAzMDQ3OTckOQ.jpg',
                    name: '沈巍q版钥匙扣',
                    price: 20,
                    type:5
                }, {
                    imgurl: 'http://up.img.heidiancdn.com/o_1d80qp4e2bkn1rb1im0f0vtf303.jpg?imageView2/2/w/1200/ignore-error/1',
                    name: '《DEPART》写真集',
                    price: 200,
                    type:2
                }, {
                    imgurl: 'http://img14.360buyimg.com/n7/jfs/t23689/66/917416745/127255/80cf9eff/5b495391N2c1b8bd9.jpg',
                    name: '沈巍帆布袋',
                    price: 50,
                    type:4
                }, {
                    imgurl: 'https://wx3.sinaimg.cn/mw690/007bZ7Vvgy1g4lybrjqhdj30mt0k1wls.jpg',
                    name: '镇魂一周年写真集',
                    price: 180,
                    type:2
                }, {
                    imgurl: 'https://wx3.sinaimg.cn/mw690/007bZ7Vvgy1g3zyeu0103j30u00u00vp.jpg',
                    name: '【当夏依旧】手机壳',
                    price: 30,
                    type:0
                }, {
                    imgurl: 'http://www.t-chs.com/tuhsJDEwLmFsaWNkbi5jb20vaTIvMjM3MDMzMzQ4MC9UQjIwNW9ma3Bvb0JLTmpTWkZQWFhYYTJYWGFfISEyMzcwMzMzNDgwJDk.jpg',
                    name: '镇魂徽章套组',
                    price: 40,
                    type:3
                }, {
                    imgurl: 'http://images.china.cn/site1007/2019-08/22/5a71c69b-a551-44eb-90ec-7bd98eaf92e5.jpg',
                    name: '【我和我的祖国】海报',
                    price: 20,
                    type:1
                }
        ...
        methods:{
            ...
            addToPocket(val) {
                if(this.boughtProducts.length!==0){
                    var product=this.boughtProducts.find(item=>item.name === val.name)
