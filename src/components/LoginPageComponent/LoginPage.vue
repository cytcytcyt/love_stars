      ...
      <el-container>
        ...
        <el-aside width="500px">
          <el-button-group>
            ...
            <el-button @click="showForm='Resign'">
              注册
          ...
          <el-form
            :model="resignForm"
            :rules="rulesForResign"
            ref="resignForm"
            v-show="showForm === 'Resign'"
          >
  ...
  methods: {
    login() {
      ...
      axios
        ...
        .then((response) => {
          if (response.data === "NO USERNAME") alert("用户名不存在");
          else if (response.data === "PASSWORD ERR") alert("密码错误");
          else {
            alert("欢迎");
